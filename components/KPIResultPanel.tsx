...
export default function KPIResultPanel({ result }: KPIResultPanelProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md space-y-6">
      <h2 className="text-2xl font-bold text-black mb-4">計算結果</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-blue-50 p-4 rounded-lg">
          <h4 className="text-sm font-medium text-black mb-1">有效每刮成本</h4>
        ...
        <div className="bg-purple-50 p-4 rounded-lg">
          <h4 className="text-sm font-medium text-black mb-1">平均每中一次成本</h4>
        ...
        <div className="bg-green-50 p-4 rounded-lg">
          <h4 className="text-sm font-medium text-black mb-1">期望中獎次數</h4>
        ...
        <div className="bg-orange-50 p-4 rounded-lg">
          <h4 className="text-sm font-medium text-black mb-1">期望總成本</h4>
      ...
      {/* 解释说明 */}
      <div className="bg-black bg-opacity-5 p-4 rounded-lg border-l-4 border-blue-500">
        <h4 className="font-semibold text-black mb-2">如何理解这些数字？</h4>
