    ...
    <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          type="button"
          onClick={loadExample}
          className="px-3 py-1 text-sm bg-black bg-opacity-10 hover:bg-opacity-20 rounded-md transition-colors"
        >
          載入範例
        </button>
      </div>
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-black disabled:bg-opacity-40 text-white font-semibold py-3 px-6 rounded-md transition-colors"
      >
